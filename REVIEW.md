...
1. Do not start reviewing a pull request if it is a draft mode until it is marked as [ready to review](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/.changing-the-stage-of-a-pull-request#marking-a-pull-request-as-ready-for-review).
2. Do not start reviewing a pull request if automated checks fail. Wait until they are fixed by the author.
3. Pull requests except those generated by bots should have an associated issue opened before the PR. Motivations and designs SHOULD be discussed in the corresponding issue instead of in the pull request. Minor changes may be exempt at the maintainers' discretion.
