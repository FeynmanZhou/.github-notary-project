...
Everyone is encouraged to review code and documentation change, even if they are not officially reviewer. However, only pull requests approved by maintainers can be merged.
...
6. Reviews from maintainers are required. Only pull requests approved by **at least one repo maintainer** can be merged. If the author is a maintainer, the pull request is required to be approved by other maintainers.
